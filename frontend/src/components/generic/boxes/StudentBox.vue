  ...
  <div class="student-box">
    <div class="box-body">
      ...
      <div class="location-row">
        ...
        <input type="text" v-model="form.zip" placeholder="CP" aria-label="Código Postal" />
...
export default {
  ...
  methods: {
    mapItemToForm (i) {
      ...
      return {
        fullName: i.fullName || [i.name, i.surname, i.secondSurname].filter(Boolean).join(' ') || '',
        degree: i.degree || i.titulacion || '',
        city: i.city || '',
        zip: i.zip || i.cp || '',
        address: i.address || '',
